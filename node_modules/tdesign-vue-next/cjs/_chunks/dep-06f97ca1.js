...
var _commonjsHelpers = require('./dep-0a56babd.js');
var _slicedToArray = require('@babel/runtime/helpers/slicedToArray');
var _objectDestructuringEmpty = require('@babel/runtime/helpers/objectDestructuringEmpty');
var _extends = require('@babel/runtime/helpers/extends');
var _defineProperty = require('@babel/runtime/helpers/defineProperty');
var isFunction = require('lodash/isFunction');
var customParseFormat = require('./dep-e2f5caca.js');
      ...
      return row.map(function (item) {
        ...
        if (multiple) {
          _item.active = value.some(function (val) {
            return isSame(dayjs__default["default"](val).toDate(), _item.value);
          });
        } else {
...
//# sourceMappingURL=dep-06f97ca1.js.map
