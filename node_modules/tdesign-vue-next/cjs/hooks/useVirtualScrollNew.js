...
var useVirtualScroll = function useVirtualScroll(container, params) {
  ...
  function getVisibleRangeConfig() {
    ...
    var stickyHeight = sum__default["default"](trHeightList.slice(0, Math.min(startIndex, fixedStart)));
    return {
  ...
  var updateScrollTop = function updateScrollTop(_ref3) {
    ...
    var scrollTop = sum__default["default"](trHeightList.slice(0, index + 1)) - top;
