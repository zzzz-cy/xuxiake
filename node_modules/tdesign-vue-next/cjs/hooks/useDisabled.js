...
function useDisabled(context) {
  ...
  return Vue.computed(function () {
    ...
    if (isBoolean__default["default"](context === null || context === void 0 || (_context$beforeDisabl = context.beforeDisabled) === null || _context$beforeDisabl === void 0 ? void 0 : _context$beforeDisabl.value)) return context.beforeDisabled.value;
    if (isBoolean__default["default"](componentDisabled.value)) return componentDisabled.value;
    if (isBoolean__default["default"](context === null || context === void 0 || (_context$afterDisable = context.afterDisabled) === null || _context$afterDisable === void 0 ? void 0 : _context$afterDisable.value)) return context.afterDisabled.value;
