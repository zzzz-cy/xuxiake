...
var TTabNav = Vue.defineComponent(_objectSpread(_objectSpread({
  ...
  setup: function setup(props) {
    ...
    var setOffset = function setOffset(offset) {
      scrollLeft.value = _common_js_tabs_base.calcValidOffset(offset, maxScrollLeft.value);
    };
    var handleScroll = function handleScroll(action) {
      setOffset(_common_js_tabs_base.calcPrevOrNextOffset(getRefs(), scrollLeft.value, action));
    };
    ...
    var handleActiveTabScroll = function handleActiveTabScroll() {
      setTimeout(function () {
        setOffset(_common_js_tabs_base.calculateOffset(getRefs(), scrollLeft.value, props.scrollPosition));
      }, 0);
    };
    var getMaxScrollLeft = function getMaxScrollLeft() {
      Vue.nextTick(function () {
        maxScrollLeft.value = _common_js_tabs_base.calcMaxOffset(getRefs());
      });
    };
    Vue.watch([function () {
    ...
    hooks_useListener.useResize(debounce__default["default"](getMaxScrollLeft), navsContainerRef.value);
