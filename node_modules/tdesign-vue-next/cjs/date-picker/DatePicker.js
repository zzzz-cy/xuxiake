...
var _DatePicker = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    Vue.watch(popupVisible, function (visible) {
      ...
      if (visible) {
        year.value = _common_js_datePicker_utils.parseToDayjs(value.value, formatRef.value.valueType).year();
    ...
    function onPresetClick(presetValue) {
      ...
      inputValue.value = _common_js_datePicker_utils.formatDate(presetVal, {
        format: formatRef.value.format
      });
      popupVisible.value = false;
    }
