...
var _Dropdown = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var manualCloseTimeout = Vue.computed(function () {
      ...
      if (isArray__default["default"](delay)) return ((_delay$ = delay[1]) !== null && _delay$ !== void 0 ? _delay$ : delay[0]) + 10;
      return 160;
    });
    ...
    return function () {
      ...
      return Vue.createVNode(popup_index.Popup, Vue.mergeProps({
        ...
        content: function content() {
          var _options$value;
          return Vue.createVNode(Vue.Fragment, null, [renderTNodeJSX("panelTopContent"), (_options$value = options.value) !== null && _options$value !== void 0 && _options$value.length ? Vue.createVNode(dropdown_dropdownMenu["default"], Vue.mergeProps(omit__default["default"](props2, "onClick"), {
