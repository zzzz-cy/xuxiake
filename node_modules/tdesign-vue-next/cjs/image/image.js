...
var _Image = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    function renderImage() {
      var url = isString__default["default"](imageStrSrc.value) ? imageStrSrc.value : previewUrl.value;
      ...
      return Vue.createVNode("div", Vue.mergeProps({
        ...
        "default": function _default() {
          return [Vue.createVNode(tdesignIconsVueNext.ImageIcon, {
            "size": "24px"
          }, null), isString__default["default"](props2.loading) ? props2.loading : globalConfig.value.loadingText];
        }
        ...
        defaultNode: Vue.createVNode(space_index.Space, {
          ...
          "default": function _default() {
            return [Vue.createVNode(tdesignIconsVueNext.ImageErrorIcon, {
              "size": "24px"
            }, null), isString__default["default"](props2.error) ? props2.error : globalConfig.value.errorText];
          }
        })
      })]), renderOverlay()]);
    };
