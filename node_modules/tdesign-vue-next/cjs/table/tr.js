...
var TrElement = Vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var trStyles = Vue.computed(function () {
      return table_hooks_useFixed.getRowFixedStyles(get__default["default"](props.row, props.rowKey || "id"), props.rowIndex, props.dataLength, props.fixedRows, props.rowAndColFixedPosition, tableRowFixedClasses, props.virtualConfig.isVirtualScroll.value ? props.virtualConfig.translateY.value : 0);
    });
