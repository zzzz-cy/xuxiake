...
declare const _default: import("vue").DefineComponent<{
    disableDate: PropType<import("../type").DisableDate>;
    mode: {
    ...
    value: PropType<import("../type").DateValue>;
    timePickerProps: PropType<import("../..").TdTimePickerProps>;
    presets: PropType<import("../type").PresetDate>;
