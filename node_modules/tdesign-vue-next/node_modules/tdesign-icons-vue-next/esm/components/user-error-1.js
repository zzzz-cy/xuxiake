...
var userError1 = defineComponent({
  name: "UserError1Icon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-user-error-1", className.value]);
...
export default userError1;
//# sourceMappingURL=user-error-1.js.map
