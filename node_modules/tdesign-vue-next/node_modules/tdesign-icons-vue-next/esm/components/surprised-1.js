...
var surprised1 = defineComponent({
  name: "Surprised1Icon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-surprised-1", className.value]);
...
export default surprised1;
//# sourceMappingURL=surprised-1.js.map
