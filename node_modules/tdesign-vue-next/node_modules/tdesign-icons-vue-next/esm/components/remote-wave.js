...
var remoteWave = defineComponent({
  name: "RemoteWaveIcon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-remote-wave", className.value]);
...
export default remoteWave;
//# sourceMappingURL=remote-wave.js.map
