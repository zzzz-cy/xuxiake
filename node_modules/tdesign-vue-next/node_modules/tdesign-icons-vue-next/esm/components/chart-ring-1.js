...
var chartRing1 = defineComponent({
  name: "ChartRing1Icon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-chart-ring-1", className.value]);
...
export default chartRing1;
//# sourceMappingURL=chart-ring-1.js.map
