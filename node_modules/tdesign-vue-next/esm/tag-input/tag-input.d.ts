...
declare const _default: import("vue").DefineComponent<{
    ...
    CLEAR_CLASS: import("vue").ComputedRef<any>;
    ...
    onInnerFocus: (value: import("../input").InputValue, context: {
        e: FocusEvent;
    }) => void;
    onInnerBlur: (value: import("../input").InputValue, context: {
        e: FocusEvent;
    }) => void;
    ...
    onInputBackspaceKeyDown: (value: import("../input").InputValue, context: {
        e: KeyboardEvent;
    }) => void;
