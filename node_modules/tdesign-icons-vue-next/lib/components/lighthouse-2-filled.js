...
var element = {
  ...
  "children": [{
    ...
    "attrs": {
      "fill": "currentColor",
      "d": "M9 2V1H7v4H6v2h1v3c0 .94-.07 1.96-.2 3H5v2h1.52a59.91 59.91 0 01-1.4 6.43c-.1.37-.2.75-.32 1.12l-.13.45h5.61l1-4h1.44l1 4h5.6a191.6 191.6 0 00-.44-1.57 55.93 55.93 0 01-.9-3.76 59.9 59.9 0 01-.5-2.67H19v-2h-1.8a26.4 26.4 0 01-.2-3V7h1V5h-1V1h-2v1H9zm0 3V4h6v1H9zm4 4v2h-2V9h2z"
    }
  }]
};
