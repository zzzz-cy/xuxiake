...
var mapConnectionFilled = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-map-connection-filled", className.value]);
...
exports.default = mapConnectionFilled;
