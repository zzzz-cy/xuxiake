...
var fileTransmitDoubleFilled = vue.defineComponent({
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-file-transmit-double-filled", className.value]);
...
exports.default = fileTransmitDoubleFilled;
