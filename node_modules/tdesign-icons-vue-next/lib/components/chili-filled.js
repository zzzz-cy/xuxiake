...
var chiliFilled = vue.defineComponent({
  name: "ChiliFilledIcon",
  props: {
    size: {
      type: String
    },
  ...
  setup(props, _ref) {
    ...
    var finalCls = vue.computed(() => ["t-icon", "t-icon-chili-filled", className.value]);
...
exports.default = chiliFilled;
//# sourceMappingURL=chili-filled.js.map
