...
var element = {
  ...
  "children": [{
    ...
    "attrs": {
      "fill": "currentColor",
      "d": "M6.5 1.5h-5v5h2v-3h3v-2zM22.5 1.5h-5v2h3v3h2v-5zM18.05 7.34L12 3.84l-6.05 3.5 6.05 3.5 6.05-3.5zM19.06 9.07L13 12.57v7l6.06-3.5v-7zM11 19.58v-7.01l-6.06-3.5v7l6.06 3.5zM3.5 20.5v-3h-2v5h5v-2h-3zM22.5 22.5v-5h-2v3h-3v2h5z"
    }
  }]
};
