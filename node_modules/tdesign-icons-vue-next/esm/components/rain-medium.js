...
var rainMedium = defineComponent({
  name: "RainMediumIcon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-rain-medium", className.value]);
...
export default rainMedium;
//# sourceMappingURL=rain-medium.js.map
