...
var feelAtEase = defineComponent({
  name: "FeelAtEaseIcon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-feel-at-ease", className.value]);
...
export default feelAtEase;
//# sourceMappingURL=feel-at-ease.js.map
