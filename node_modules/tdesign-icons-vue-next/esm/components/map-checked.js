...
var mapChecked = defineComponent({
  name: "MapCheckedIcon",
  props: {
    size: {
      type: String
  ...
  setup(props, _ref) {
    ...
    var finalCls = computed(() => ["t-icon", "t-icon-map-checked", className.value]);
...
export default mapChecked;
//# sourceMappingURL=map-checked.js.map
